...
const Selected_item = (props) => {
    ...
    const [selectedImage_item, setSelectedImage_item] = useState('');
    ...
    return (
        <div className='container'>
            ...
            <div className='col-lg-5 col-md-12 col-12 mt-5 mb-5 ps-3'>
                    {item ? (
                        <div className='mt-5'> 
                            <img
                                src={require(`../images/items/${selectedImage_item || item.item_image1}`)}
                                alt=""
                ...
                <div className='col-lg-6 col-md-12 col-12 mt-5 ps-5'>
                    {item ? (
                        <div className='mt-5'>
                        ...
                        <button className='btn btn-dark mt-2' onClick={handleSaved}>Save For Later</button>
                        <hr />
                    <div className="row mt-3">
                        ...
                        <h5 className='mt-2 mb-3'>Total Amount: ₱ {calculateTotalAmount()}</h5>
                        <hr />
                        <div className="mb-3 mt-2 col-12"> 
                        <label htmlFor="address" className="form-label"><h5>Address</h5></label>
...
<hr />
                        ...
                        <button className='btn btn-dark mb-5' onClick={handleBuy}>Purchase</button>
